                ...
                <div class="col-lg-12">
                    ...
                    if ($Comment->canUpdate() && !$Comment->isDeleted()) {
                        ...
                        <div class="edit">
                            ...
                            echo Comments\widgets\CommentFormWidget::widget([
								...
								'item_id' => $CommentListWidget->item_id,
                                'Comment' => $Comment,
                    ...
                    <div class="actions">
                        ...
                        if (!$Comment->isDeleted()) {
							...
							if(Yii::$app->user->can('customer') && $Comment->canChange() && Yii::$app->controller->route != 'orders/responce'):
							echo Html::a(
                                    FA::icon('times') . ' ' . Yii::t('app', 'Change'),
                                    Url::current(['change-performer' => $Comment->from, 'item-id' => $Comment->item_id]),
                                    ['class' => 'btn btn-primary btn-xs']
                                );
							endif;
							if(Yii::$app->controller->route == 'orders/responce'){
							if($Comment->value == 0)
							{
								echo '<div class="alert-danger alert fade in">Негативний коментарій</div>';
							}
							else
							{
								echo '<div class="alert-success alert fade in">Позитивний коментарій</div>';
							}
							}
						}
                        ?>
...
if ($CommentListWidget->showCreateForm && $CommentModel::canCreate()) {
    ...
    echo Comments\widgets\CommentFormWidget::widget([
        ...
        'entity' => $CommentListWidget->entity,
		'item_id' => $CommentListWidget->item_id,
        'type_id' => $CommentListWidget->type_id,
