...
public $value;
	...
	{
		return Orders::findOne($this->item_id)['user_id'] == Yii::$app->user->id ? true : false ;
	}

    public function getVote()
	{
		return Rating::find()->where(['target_id' => $this->item_id])->andwhere(['model_id' => $this->created_by])->all();
	}
